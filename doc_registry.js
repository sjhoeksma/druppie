...
const DOC_REGISTRY = {
    "blocks": [
        ...
        { name: "AI Image (SDXL)", path: "blocks/ai_image.md" },
        { name: "AI Audio (TTS)", path: "blocks/ai_text_to_speech.md" },
        { name: "File Reader Utility", path: "blocks/util_file_reader.md" },
    ...
    "agents": [
        ...
        { name: "Infrastructure Engineer", path: "agents/infrastructure_engineer.md" },
        { name: "Skill Dispatcher", path: "agents/skill_executor.md" },
        { name: "Tester", path: "agents/tester.md" },
        { name: "Video Content Creator", path: "agents/video_content_creator.md" },
        { name: "Native Workflow Engineer", path: "agents/native_converter.md" },
        ...
        { name: "Audio Creator", path: "agents/audio_creator.md" },
        { name: "Image Creator", path: "agents/image_creator.md" },
        { name: "Video Creator", path: "agents/video_creator.md" },
        { name: "Registry Expert", path: "agents/registry_expert.md" },
        { name: "MCP Specialist", path: "agents/mcp_agent.md" },
        { name: "MCP Plugin Developer", path: "agents/mcp_plugin_developer.md" },
    ],
    "skills": [
        ...
        { name: "Check Block Status", path: "skills/check_block_status.md" },
        { name: "WCAG 2.1 AA", path: "skills/wcag_2_1_aa.md" },
        { name: "Ask Questions", path: "skills/ask_questions.md" },
        { name: "Audio Review", path: "skills/audio_review.md" },
        { name: "Content Merge", path: "skills/content_merge.md" },
        { name: "Content Review", path: "skills/content_review.md" },
        { name: "Creative Writing", path: "skills/creative_writing.md" },
        { name: "Expand Loop", path: "skills/expand_loop.md" },
        { name: "Image Review", path: "skills/image_review.md" },
        { name: "Main Agent Logic", path: "skills/main_agent.md" },
        { name: "Orchestration", path: "skills/orchestration.md" },
        { name: "Sub-Agent Logic", path: "skills/sub_agent.md" },
        { name: "Registry Lookup", path: "skills/registry_lookup.md" },
        { name: "Video Review", path: "skills/video_review.md" }
    ],
    "research": [
