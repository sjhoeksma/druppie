...
Voordat de Core een taak uitvoert, checkt hij de [Bouwblok Definities](./../design/bouwblok_definities.md):
...
- **Raadpleegt**: [Bouwblok Definities](./../design/bouwblok_definities.md) om te zien wat er al is.
- **Initieert**: [Builder Agent](../build_plane/builder_agent.md) als er een nieuw blok gebouwd moet worden.
- **Controleert**: [Policy Engine](./../design/policy_engine.md) voor validatie van het plan.